...
// select 方法
  ...
  public <E> List<E> selectList(String statement, Object parameter, RowBounds rowBounds) {
    try {
      ...
      return executor.query(ms, wrapCollection(parameter), rowBounds, Executor.NO_RESULT_HANDLER);//executor
    } catch (Exception e) {
...
//对Sql编译和参数初始化
  private Statement prepareStatement(StatementHandler handler, Log statementLog) throws SQLException {
    ...
    stmt = handler.prepare(connection, transaction.getTimeout()); //参数预编译
